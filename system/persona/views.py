    ...
    try:
        ...
        if len(persona) == 0:
            ...
            for asig in dicc["lineas"]:
                ...
                del asig['linea']
                del asig['interno']
                internopersona = InternoPersona.objects.create(**asig)
                ...
                **dict(fkusuario=user,fkinternoPersona=internopersona.id,fklinea=asig["fklinea"].id,  linea=asig["fklinea"].codigo,
